...
| 阶段 | 堑壕范围 |
|---|---|
| P3 | 1 张小型堑壕地图、3-5 个简单敌人、搜索节点、3 人纵队、小地图、简单血量、胜负结算 |
| Later | 第 2 张地图、敌人巡逻/找掩体/投掷、队友手榴弹/火力支援/换弹掩护、拐角拉回玩家 |

P3 敌人 AI 只要求出现、发现玩家、射击和死亡；高级战术行为不得作为 P3 完成前置条件。
...
- 堑壕地图数量为 2 张。
- P3 可先交付 1 张小型堑壕地图，第 2 张地图属于后续扩展。
- 敌人开局生成 3 到 5 个。
...
- 敌人死亡后尸体不消失。
- 命中敌人必须触发中弹音效事件。
- P3 敌人逻辑必须支持固定随机种子和测试指定生成结果，保证 PlayMode Test 可复现。
